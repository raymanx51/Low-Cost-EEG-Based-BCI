...
class Scope(object):
    ...
    def start(self):
        # Serial variables
        # Old baud: 57600
        self.ser = serial.Serial(self.port, baudrate=38400, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE,
        ...
        self.filename = '\\Users\\Ray\\Documents\\EEG_csv\\' + time.ctime() + '.csv'
